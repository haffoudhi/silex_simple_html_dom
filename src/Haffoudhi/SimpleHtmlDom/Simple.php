<?php
namespace Haffoudhi\SimpleHtmlDom; 
...
$dom = new Simple(null, $lowercase, $forceTagsClosed, $target_charset, $stripRN, $defaultBRText, $defaultSpanText);
...
{
$this->char = (++$this->pos<$this->size) ? $this->doc[$this->pos] : null; // next
// This represents the change in the Simple trunk from revision 180 to 181.
